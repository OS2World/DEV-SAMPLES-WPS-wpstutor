...
/* WINDOWDATA is defined in the IDL passthru C_h_after inside #ifdef __PRIVATE__
 * so sc does not emit it into wpstutor.h without that flag.  Define it here,
 * after wpstutor.ih so WPSTutorial, USEITEM, and VIEWITEM are already declared. */
